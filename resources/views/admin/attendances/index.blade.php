    ...
    <div class="py-1">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-end mb-4">
                <form action="{{ route('admin.attendances.index') }}" method="GET" id="filter-form"
                        ...
                        <table class="min-w-[1000px] w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50 sticky top-0">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left font-medium text-gray-900">Nilai Absen</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <input type="number" step="0.1" min="0" max="100"
                                                name="components[{{ $i }}][attendance]"
                                                value="{{ $existingAttendanceData->get($enrollment->id) ?? old("components.$i.attendance") }}"
